For assets and media files thanks to https://github.com/coder-smookki/DOOM-1993/tree/main
1. You need to install  opencv, SDL(project was made with 2.26.3 version) and SFML(project was made with 2.6.0 version) libraries to C:/ folder
