...
class Menu
{
	public:
        Menu();
        bool check_hover(int button_id); //returns true if the mouse is over a button and calls handme_click if a mouse button is pressed
        void handle_click(int button_id); //handle the buttons logic
